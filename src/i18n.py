...
TRANSLATIONS = {
    "en": {
        ...
        "snap_mode_album": "Mode 1: Add to album (Default)",
        "snap_mode_nikkibook": "Mode 2: Save to NikkiBook only",
        "capture_area_label": "Screenshot capture area:",
        "capture_area_full": "Full Area",
        "capture_area_mid": "Mid Area",
        ...
        "added_label": "Added: —",
        "added_prefix": "Added:",
        "delete_image_btn": "🗑️  Delete Image",
        ...
        # Context menu
        "rename_action": "✏️  Rename",
        "delete_action": "🗑️  Delete",
    ...
    "zh": {
        ...
        "snap_mode_album": "模式 1：添加到星绘图册（默认）",
        "snap_mode_nikkibook": "模式 2：仅保存到 NikkiBook",
        "capture_area_label": "截图区域：",
        "capture_area_full": "全景",
        "capture_area_mid": "中间区域",
        "language_label": "界面语言：",
    ...
    "ja": {
        ...
        "snap_mode_album": "モード 1：アルバムに追加（デフォルト）",
        "snap_mode_nikkibook": "モード 2：NikkiBook のみ保存",
        "capture_area_label": "スクリーンショット範囲：",
        "capture_area_full": "全範囲",
        "capture_area_mid": "中央範囲",
        "language_label": "表示言語：",

...
import tempfile
from PyQt6.QtCore import Qt, QMimeData, QByteArray, QSize, QSettings
...
class MainWindow(QMainWindow):
    ...
    Layout:
    ┌──────────────────────────────────────────────────────────────────┐
    │ [Logo]  [Search________________________]  Sort: [▼]  [+Add] [⚙] │
    ├──────────────┬───────────────────────────────────────────────────┤
    │   Sidebar    │                                                   │
    │  [+Cat][+Sub]│              Gallery                              │
    ...
    def _setup_ui(self):
        ...
        # Use native Windows icon font (Segoe Fluent/MDL2) for clean outline icon
    ...
    def _retranslate(self):
        """Re-apply all translatable strings in the main window."""
        self.search_input.setPlaceholderText(t("search_placeholder"))

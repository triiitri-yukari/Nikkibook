...
class ThumbnailWidget(QFrame):
    ...
    def _setup_ui(self):
        ...
        # Keep copy and success feedback in the same bundled outline set as
        # the toolbar and category controls.
        self.copy_icon_normal = ui_icon("copy", styles.COLORS['primary'], 16)
        self.copy_icon_hover = ui_icon("copy", "white", 16)
        self.tick_icon = ui_icon("check", "white", 16)
        
        self.copy_btn.setIcon(self.copy_icon_normal)
        self.copy_btn.setIconSize(icon_size(16))
    ...
    def _set_placeholder(self):
        ...
        self.thumb_label.setPixmap(ui_icon("image", styles.COLORS['text_light'], 48).pixmap(icon_size(48)))

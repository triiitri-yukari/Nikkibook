...
from PyQt6.QtWidgets import (
    ...
    QTreeWidgetItem, QMenu, QSizePolicy, QLabel
)
...
class CategoryTree(QWidget):
    ...
    def _load_data(self):
        ...
        for cat in categories:
            ...
            for subcat in subcategories:
                ...
                subcat_item.setText(0, f"        {subcat['name']}")
    ...
    def _show_context_menu(self, position):
        ...
        # Rename action
        rename_action = QAction(t("rename_action"), self)
        rename_action.triggered.connect(lambda: self._rename_item(item))
        menu.addAction(rename_action)
        
        # Delete action
        delete_action = QAction(t("delete_action"), self)
